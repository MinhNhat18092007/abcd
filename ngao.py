...
pygame.mixer.init()
pygame.mixer.music.load("DemNguoc.mp3")
...
for timer in range(countdown, -1, -1):
    pen.clear()
    pen.color("#D4AF37")
    pen.write(timer, align="center", font=("Algerian", 80, "bold"))
    time.sleep(1)
...
pen.write("\nHappy New Year !", align="center", font=("Algerian", 80, "bold"))
time.sleep(3)
...
# pygame.mixer.music.play(loops=0)
# pygame.mixer.init()
# pygame.mixer.music.load("PhaoHoa.mp3")
# pygame.mixer.music.play(loops=0)
# pygame.mixer.init()
pygame.mixer.music.load("HappyNewYear.mp3")
pygame.mixer.music.play(loops=0)
...
class Random():
    ...
    def randomBulletFlyUp_x():  # Vị trí viên đạn bay lên
        x = random.randint(int(WINDOWWIDTH*0.04), int(WINDOWHEIGHT*2.1))
        return x

def main():
    global FPSCLOCK, DISPLAYSURF
    pygame.init()
    pygame.display.set_caption('Bắn pháo hoa!')
